...
- **Criação Automática**: Cards gerados via JavaScript (DOM Manipulation).
- **Ficha Técnica**: Exibição de peso e altura reais para Pokémon.
...
## 🔗 Links
- **Site Online**: [https://haaisee03.github.io/devflix-unifecaf/]

---
**Desenvolvido por Isaias Bruno da Silva Júnior**
